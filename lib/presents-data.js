var presentsData = {
    "default": {
        ...
        pdf: '<p> </p>\n<p><a href="{pdf}" target="blank" data-toggle="&quot;collapse&quot;"><img class="article-inline-image" src="http://investmoscow.ru/media/3025280/icons-pdf.png?width=32" alt="" /> Скачать</a></p>',
        after: ''
    },
    "cityLife": {
    ...
    "agencyDigest": {
        ...
        other: '<a rel="gallery{galleryNum}" href="{link}" class="fancybox dnone" data-toggle="&quot;collapse&quot;"></a>',
        pdf: '</p>\n<div class="text">\n<a href="{pdf}" target="blank" data-toggle="&quot;collapse&quot;"><img src="http://investmoscow.ru/media/3025280/icons-pdf.png?width=32" class="article-inline-image"> &nbsp;<strong>{title}</strong></a>\n</div>\n',
        after: '</div>\n</div>'
    }
};
